...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/01/14 17:47:26 by asibille          #+#    #+#             */
/*   Updated: 2022/01/14 17:47:38 by asibille         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_putuns_hexa_count(size_t u, int fd, int *size, t_conv_flags *fl)
{
	char	hexaset[16];
	size_t	div;
...
void	ft_uns_hexa(unsigned int u, t_conv_flags *fl, int *size)
{
	...
	if ((fl->point) || u || !(fl->ispoint))
		ft_putuns_hexa_count((size_t) u, 1, size, fl);
	if (fl->minus)
		ft_flag_width_x((size_t) u, fl, size);
}
